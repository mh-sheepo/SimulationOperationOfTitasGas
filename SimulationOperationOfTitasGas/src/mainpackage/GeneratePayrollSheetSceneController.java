 ...
 * @author sLiNK
 */
public class GeneratePayrollSheetSceneController implements Initializable {

    @FXML
    private Label leaveBalanceLabel;
    @FXML
    private Label postingLabel;
    @FXML
    private Label designationLabel;
    @FXML
    private Label medicalLabel;
    @FXML
    private Label conveyanceLabel;
    @FXML
    ...
    @FXML
    private void addToPayrollSheetButtonOnClick(ActionEvent event) {
    }
