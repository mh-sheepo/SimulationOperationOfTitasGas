 ...
 * @author Momo
 */
public class ViewInventoryRequestItemsController implements Initializable {

    @FXML
    private Button acceptfxid;
    @FXML
    private Button denyfxid;
    @FXML
    private Button removeitemsfxid;
    ...
    private void logout_button(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(ViewInventoryRequestItemsController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
