 ...
 * @author Momo
 */
public class TotalInventoryCostListSendingOfOperationManagerController implements Initializable {
    ...
    @FXML
    private void Logout_buttonj(ActionEvent event) throws IOException {
