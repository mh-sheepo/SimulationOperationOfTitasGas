 ...
 * @author Momo
 */
public class ViewInventoryItemsController implements Initializable {
    ...
    private void logout_button(ActionEvent event) {
        try {
            ...
            Logger.getLogger(ViewInventoryItemsController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
